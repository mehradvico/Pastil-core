...
namespace Api.Areas.Admin.Controllers
{
    ...
    public class CompanionAssistancePackageOnlineController : ControllerBase
    {
        ...
        [HttpPost]
        [ProducesResponseType(typeof(BaseResultDto<CompanionAssistancePackageOnlineDto>), 200)]
        public async Task<IActionResult> Post(CompanionAssistancePackageOnlineDto dto)
        {
            var result = await _companionAssistancePackageOnlineService.InsertAsyncDto(dto);
            return Ok(result);
        }
        ...
        public IActionResult Put(CompanionAssistancePackageOnlineDto dto)
        {
            var agency = _companionAssistancePackageOnlineService.UpdateDto(dto);
            return Ok(agency);
        }
        ...
        {
            var dto = _companionAssistancePackageOnlineService.DeleteDto(id);
            return Ok(dto);
        }
    }
}
