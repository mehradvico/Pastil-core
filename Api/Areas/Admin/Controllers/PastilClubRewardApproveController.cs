...
namespace Api.Areas.Admin.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class PastilClubRewardApproveController : ControllerBase
    {
        private readonly IClubRewardOfferService _service;
        private readonly ICurrentUserHelper _currentUser;

        public PastilClubRewardApproveController(IClubRewardOfferService service, ICurrentUserHelper currentUser)
        {
            _service = service;
        ...
        public async Task<IActionResult> Post(ClubRewardOfferDecisionDto dto, CancellationToken cancellationToken) =>
            Ok(await _service.ApproveAsync(dto.RewardOfferId, _currentUser.CurrentUser.UserId, cancellationToken));
    }
}
