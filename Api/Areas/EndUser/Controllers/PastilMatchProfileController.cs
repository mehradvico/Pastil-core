...
namespace Api.Areas.EndUser.Controllers
{
    ...
    public class PastilMatchProfileController : ControllerBase
    {
        ...
        /// 
        [HttpPost]
        [ProducesResponseType(typeof(BaseResultDto<PastilMatchProfileDto>), 200)]
        public async Task<IActionResult> Post(PastilMatchProfileDto dto)
        {
            var result = await _pastilMatchProfileService.InsertAsyncDto(dto);
            return Ok(result);
        }
        ...
        public IActionResult Put(PastilMatchProfileDto dto)
        {
            var result = _pastilMatchProfileService.UpdateDto(dto);
            return Ok(result);
        }
