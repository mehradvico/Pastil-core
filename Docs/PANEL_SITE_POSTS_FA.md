...
حذف تصویر ضمیمه با حذف آن از `postPicturesList` و ارسال مجدد DTO کامل انجام می‌شود. بک‌اند هنگام ویرایش، فهرست تصاویر را به‌صورت کامل جایگزین می‌کند. همچنین می‌توان یک رابطه تصویر را مستقیماً با endpoint زیر حذف کرد:
...
هر کاربری که Permission ویرایش پست دارد، می‌تواند پست را بدون محدودیت تعداد دفعات مستقیماً ویرایش کند. بک‌اند دیگر براساس فیلد `edited` ویرایش را مسدود نمی‌کند و نسخه Child نمی‌سازد.
