namespace Application.Services.Setting.NoticeSrv
{
    public static class NoticeTypeLabels
    {
        ...
        public const string PansionUpdated = "Pansion.Updated";
        ...
        public const string CompanionAssistanceUpdated = "CompanionAssistance.Updated";
        public const string CompanionAssistancePackageSubmitted = "CompanionAssistancePackage.Submitted";
        public const string CompanionAssistancePackageUpdated = "CompanionAssistancePackage.Updated";
        public const string CompanionAssistanceReportSubmitted = "CompanionAssistanceReport.Submitted";
        public const string CompanionReportSubmitted = "CompanionReport.Submitted";
        public const string CompanionUserSubmitted = "CompanionUser.Submitted";
        public const string DriverSubmitted = "Driver.Submitted";
        public const string DriverUpdated = "Driver.Updated";
        public const string StoreSubmitted = "Store.Submitted";
        public const string StoreUpdated = "Store.Updated";
        public const string UserBankCardSubmitted = "UserBankCard.Submitted";
