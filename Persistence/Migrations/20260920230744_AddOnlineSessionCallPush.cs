...
{
    /// <inheritdoc />
    public partial class AddOnlineSessionCallPush : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // بدون تغییر ساختار جدول؛ فقط نوع و الگوی پوش «زنگ خوردن تماس جلسه‌ی آنلاین» (شناسه ۶۸) ثبت می‌شود.
...
WHERE pattern.PushTypeId = 68;

DELETE FROM PushPatterns WHERE PushTypeId = 68;
DELETE FROM PushTypes WHERE Id = 68 AND Label = N'PushOnlineSessionCallStarted';
");
        }
    }
}
